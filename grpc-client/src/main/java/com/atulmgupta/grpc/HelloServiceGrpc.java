...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<HelloRequest,
      HelloResponse> getWelcomeMethod;
  ...
  public static io.grpc.MethodDescriptor<HelloRequest,
      HelloResponse> getWelcomeMethod() {
    io.grpc.MethodDescriptor<HelloRequest, HelloResponse> getWelcomeMethod;
    if ((getWelcomeMethod = HelloServiceGrpc.getWelcomeMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getWelcomeMethod = HelloServiceGrpc.getWelcomeMethod) == null) {
          HelloServiceGrpc.getWelcomeMethod = getWelcomeMethod =
              io.grpc.MethodDescriptor.<HelloRequest, HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  HelloResponse.getDefaultInstance()))
              .setSchemaDescriptor(new HelloServiceMethodDescriptorSupplier("welcome"))
              .build();
        }
      }
    }
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void welcome(HelloRequest request,
                        io.grpc.stub.StreamObserver<HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public HelloResponse welcome(HelloRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<HelloResponse> welcome(
        HelloRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_WELCOME = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_WELCOME:
          serviceImpl.welcome((HelloRequest) request,
              (io.grpc.stub.StreamObserver<HelloResponse>) responseObserver);
          break;
        default:
